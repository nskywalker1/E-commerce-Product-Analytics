...
- 70% кидають кошик без покупки — класична проблема abandoned cart. Рішення: email-нагадування або знижка
...
- Після дня 7 стабілізується на ~1000 юзерів — це лояльне ядро
